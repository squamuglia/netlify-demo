...
export type RootQueryMembersArgs = {
  ...
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  where?: Maybe<RootQueryToMemberConnectionWhereArgs>;
};
...
/** The category type */
export type Category = Node & TermNode & UniformResourceIdentifiable & HierarchicalTermNode & {
  __typename?: 'Category';
  /**
...
export type Post = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithContentEditor & NodeWithAuthor & NodeWithFeaturedImage & NodeWithExcerpt & NodeWithComments & NodeWithTrackbacks & NodeWithRevisions & {
  ...
  /**
   * The spanish translation of the post content
   * @deprecated 
   */
  ...
  slug?: Maybe<Scalars['String']>;
  /** @deprecated  */
  spanishTitle?: Maybe<Post_Spanishtitle>;
  /** @deprecated  */
  spanishTranslation?: Maybe<Post_Spanishtranslation>;
  /**
  ...
  title?: Maybe<Scalars['String']>;
  /**
   * The spanish translation of the post title
   * @deprecated 
   */
...
export type ContentTemplateUnion = DefaultTemplate | AboutUsTemplate | CoverTemplateTemplate | DonateTemplate | FullWidthTemplateTemplate;
...
/** The template assigned to the node */
export type AboutUsTemplate = ContentTemplate & {
  __typename?: 'AboutUsTemplate';
  /**
   * The name of the template
   * @deprecated 
   */
...
/** The template assigned to the node */
export type DonateTemplate = ContentTemplate & {
  __typename?: 'DonateTemplate';
  /**
   * The name of the template
   * @deprecated 
   */
...
/** Field Group */
export type Post_Spanishtitle = {
  __typename?: 'Post_Spanishtitle';
  /** @deprecated  */
...
/** Field Group */
export type Post_Spanishtranslation = {
  __typename?: 'Post_Spanishtranslation';
  /**
   * Se puede escriturar el traslación en espanol aquí si se quiere
   * @deprecated 
   */
...
/** The member type */
export type Member = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithContentEditor & {
  __typename?: 'Member';
  /**
   * The content of the post.
   * @deprecated 
  ...
  content?: Maybe<Scalars['String']>;
  /**
   * Connection between the member type and the ContentType type
   * @deprecated 
   */
  contentType?: Maybe<MemberToContentTypeConnectionEdge>;
  /**
   * The ID of the node in the database.
   * @deprecated 
   */
  ...
  guid?: Maybe<Scalars['String']>;
  /**
   * The globally unique identifier of the members object.
   * @deprecated 
   */
  id: Scalars['ID'];
  /**
...
/** Connection between the member type and the ContentType type */
export type MemberToContentTypeConnectionEdge = {
  __typename?: 'MemberToContentTypeConnectionEdge';
  /**
   * The nodes of the connection, without the edges
   * @deprecated 
   */
...
/** The project type */
export type Project = Node & ContentNode & UniformResourceIdentifiable & NodeWithTitle & NodeWithContentEditor & {
  __typename?: 'Project';
  /**
   * The content of the post.
   * @deprecated 
  ...
  content?: Maybe<Scalars['String']>;
  /**
   * Connection between the project type and the ContentType type
   * @deprecated 
   */
  contentType?: Maybe<ProjectToContentTypeConnectionEdge>;
  /**
   * The ID of the node in the database.
   * @deprecated 
   */
  ...
  previewRevisionId?: Maybe<Scalars['ID']>;
  /** @deprecated  */
  projectDetails?: Maybe<Project_Projectdetails>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
...
/** Connection between the project type and the ContentType type */
export type ProjectToContentTypeConnectionEdge = {
  __typename?: 'ProjectToContentTypeConnectionEdge';
  /**
   * The nodes of the connection, without the edges
   * @deprecated 
   */
...
/** Field Group */
export type Project_Projectdetails = {
  __typename?: 'Project_Projectdetails';
  /** @deprecated  */
  description?: Maybe<Scalars['String']>;
  /** @deprecated  */
  descriptionSpanish?: Maybe<Scalars['String']>;
  /** @deprecated  */
  fieldGroupName?: Maybe<Scalars['String']>;
  /** @deprecated  */
  image?: Maybe<MediaItem>;
  ...
  /** @deprecated  */
  projectNameSpanish?: Maybe<Scalars['String']>;
};
...
export type GetAboutPageQuery = (
  ...
  & { members?: Maybe<(
    ...
    & { nodes?: Maybe<Array<Maybe<(
      ...
      & { memberDetails?: Maybe<(
        { __typename?: 'Member_Memberdetails' }
        & Pick<Member_Memberdetails, 'name' | 'position' | 'project' | 'team' | 'email'>
        & { image?: Maybe<(
          { __typename?: 'MediaItem' }
          & Pick<MediaItem, 'id' | 'sourceUrl' | 'title'>
        )> }
      )> }
    )>>> }
  )>, page?: Maybe<(
...
export type GetAllPostsQuery = (
  ...
  & { posts?: Maybe<(
    ...
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'Post' }
        & Pick<Post, 'title' | 'title_spanish' | 'excerpt' | 'slug' | 'date'>
        & { featuredImage?: Maybe<(
          { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
          & { node?: Maybe<(
            { __typename?: 'MediaItem' }
            ...
            & { mediaDetails?: Maybe<(
              ...
              & { sizes?: Maybe<Array<Maybe<(
                { __typename?: 'MediaSize' }
                & Pick<MediaSize, 'height' | 'name' | 'width' | 'sourceUrl'>
              )>>> }
            )> }
          )> }
        )>, author?: Maybe<(
...
export type GetPageQuery = (
  ...
  & { page?: Maybe<(
    { __typename?: 'Page' }
    & Pick<Page, 'content' | 'title'>
  )> }
);

export type GetPostBySlugWithRevisionsQueryVariables = Exact<{
  id: Scalars['ID'];
  idType: PostIdType;
}>;


export type GetPostBySlugWithRevisionsQuery = (
  { __typename?: 'RootQuery' }
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'title_spanish' | 'excerpt' | 'slug' | 'date' | 'content' | 'content_spanish'>
    & { featuredImage?: Maybe<(
      { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
      & { node?: Maybe<(
        { __typename?: 'MediaItem' }
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Post' }
          & Pick<Post, 'title' | 'title_spanish' | 'excerpt' | 'content' | 'content_spanish'>
          & { author?: Maybe<(
            { __typename?: 'NodeWithAuthorToUserConnectionEdge' }
            & { node?: Maybe<(
              { __typename?: 'User' }
  ...
  & { projects?: Maybe<(
    ...
    & { nodes?: Maybe<Array<Maybe<(
      ...
      & { projectDetails?: Maybe<(
        { __typename?: 'Project_Projectdetails' }
        & Pick<Project_Projectdetails, 'projectName' | 'projectNameSpanish' | 'description' | 'descriptionSpanish' | 'fieldGroupName'>
        & { image?: Maybe<(
          { __typename?: 'MediaItem' }
          & Pick<MediaItem, 'sourceUrl' | 'srcSet'>
          & { mediaDetails?: Maybe<(
          ...
          { __typename?: 'ACF_GoogleMap' }
          & Pick<Acf_GoogleMap, 'longitude' | 'latitude' | 'city' | 'country'>
        )> }
      )> }
    )>>> }
  )> }
